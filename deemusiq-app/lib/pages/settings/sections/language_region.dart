...
import 'package:deemusiq/collections/language_codes.dart';
import 'package:deemusiq/collections/markets.dart';
    ...
    return SectionCardWithHeading(
      ...
      children: [
        AdaptiveSelectTile<Locale>(
          ...
          secondary: const Icon(DeeMusiqIcons.language),
          options: [
            SelectItemButton(
        ...
        AdaptiveSelectTile<Market>(
          ...
          secondary: const Icon(DeeMusiqIcons.shoppingBag),
