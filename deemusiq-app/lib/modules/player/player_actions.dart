...
import 'package:deemusiq/modules/player/sibling_tracks_sheet.dart';
...
import 'package:deemusiq/provider/sleep_timer_provider.dart';
...
class PlayerActions extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, ref) {
    ...
    final isInQueue = useMemoized(() {
      if (playlist.activeTrack is! DeeMusiqFullTrackObject) return false;
      final downloadTask =
      ...
      children: [
        ...
        if (!isLocalTrack)
          Tooltip(
            ...
            child: IconButton.ghost(
              enabled: playlist.activeTrack != null,
              icon: const Icon(DeeMusiqIcons.alternativeRoute),
              onPressed: () {
        ...
        if (!kIsWeb && !isLocalTrack)
          if (isInQueue)
            ...
            Tooltip(
              ...
              child: IconButton.ghost(
                icon: Icon(
                  isDownloaded ? DeeMusiqIcons.done : DeeMusiqIcons.download,
                ),
                onPressed: playlist.activeTrack != null
                    ? () => downloader.addToQueue(
                        playlist.activeTrack! as DeeMusiqFullTrackObject)
                    : null,
              ),
            ),
